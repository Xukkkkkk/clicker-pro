...
class ClickerApp:
            ...
            try:
                ...
                for target in scan_targets:
                    ...
                    engine = VisionEngine(
                        ...
                        capture_fn=capture_fn, on_error=self.on_vision_error,
                    )
                ...
                self.safe_after(
                    ...
                    "；".join(errors), background,
                )
            except Exception as exc:
                self.safe_after(self._finish_vision_scan_error, str(exc))
    ...
    def _finish_vision_scan_error(self, error: str) -> None:
        self._set_vision_preview_hidden(False)
        self.on_vision_error(error)
